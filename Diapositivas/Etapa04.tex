...
\begin{frame}[containsverbatim]\frametitle{Ejercicio 3 - Planeación de rutas}
...
\begin{frame}[containsverbatim]\frametitle{Práctica 5 - Seguimiento de rutas}
  \begin{itemize}
  \item Código modificado en la rama correspondiente del repositorio en línea.
  \item Documento escrito con los siguientes puntos:
    \begin{itemize}
...
\begin{frame}[containsverbatim]\frametitle{Práctica 6 - Evasión de obstáculos}
 \textbf{Entregables:}
  \begin{itemize}
  \item Código modificado en la rama correspondiente del repositorio en línea.
  \item Documento escrito con los siguientes puntos:
...
\begin{frame}[containsverbatim]\frametitle{Práctica 7 - Localización}
 \textbf{Entregables:}
  \begin{itemize}
  \item Código modificado en la rama correspondiente del repositorio en línea.
  \item Documento escrito con los siguientes puntos:
