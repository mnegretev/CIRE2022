...
\begin{frame}\frametitle{Los robots en el espacio}
\end{frame}
...
\begin{frame}[containsverbatim]\frametitle{Tarea 1}
  \begin{enumerate}
...
pub_cmd_vel.publish(msg_cmd_vel)
  \end{lstlisting}
  \item Describir qué hace el programa de la tarea 1, de ser posible, agregue un diagrama de flujo o esquema similar. 
  \end{enumerate}
\end{frame}
